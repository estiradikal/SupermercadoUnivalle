...
public class VentanaClientesVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtF_cedula = new javax.swing.JTextField();
        ...
        jPanel1.add(txtF_cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 70, 190, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaClientesVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new VentanaClientesVista().setVisible(true);
            }
        });
    }
    ...
    /**
     * Cambia la cedula en el campo de texto
     * @param cedula El nuevo contenido del JTextField (String)
     */
    public void setCedula(String cedula){
        txtF_cedula.setText(cedula);
    }
    ...
    private javax.swing.JTextField txtF_cedula;
